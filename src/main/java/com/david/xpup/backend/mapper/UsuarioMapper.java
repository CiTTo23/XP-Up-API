 ...
 *       - Convertir la skin activa de perfil en su DTO correspondiente                                                *
 ...
 *       - No expone datos sensibles del usuario como la contraseña                                                    *
 *                                                                                                                     *
 ***********************************************************************************************************************/
...
public class UsuarioMapper {
    ...
    public UsuarioMapper(SkinPerfilMapper skinPerfilMapper) {
    ...
    //Construye el DTO más completo de un usuario. Mapea entity Usuario + Experiencia + Skin + Seguidores + Seguidos + Publicaciones
    public InternalUserProfileResponse toUserProfileResponse(
        ...
        response.setNivel(experiencia != null ? experiencia.getNivel() : 1);
        response.setSkinPerfil(skinPerfilMapper.toProfileSkinResponse(usuario.getSkinPerfilActiva()));
